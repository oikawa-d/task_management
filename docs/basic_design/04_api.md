...
flowchart TB
    ...
    B -->|"RedisError / InterfaceError / DisconnectionError / TimeoutError<br/>またはOperationalError（接続SQLSTATE）"| F["infra_error_handler<br/>503"]
    B -->|"OperationalError（非接続SQLSTATE）/ その他DBAPIError"| G2["infra_error_handler<br/>500 INTERNAL_ERROR"]
