...
sequenceDiagram
    autonumber
    actor U as ユーザー
    participant PCF as ProjectCreateForm
    ...
    alt バリデーションNG
        ...
        PCF->>Q: createProjectMutation.mutate({name, description})
